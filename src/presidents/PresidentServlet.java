...
//	2 create variable based on button clicked	
...
// create right president  object based on the button clicked
		PresidentBean PB1 = presidentsDAO.getPresident(number);

		PresidentBean2 PB2 = presidentsFILEDAO2.getPresident(number);
		
// set president object in the session (array or just object)		
		...
		//Finally send the information in index.jsp to render data in a webpage
		if (PB1 != null)
		{
