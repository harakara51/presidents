...
<!-- First Page	  display when session is empty	
 -->		
...
<!-- 
<form that send information to the servlet -->
...
<!-- Step number 1 -->
	...
	<!-- 
	Display if session it not empty -->
<c:if test="${! empty(sessionScope.presidents)}">
		<div class="mdl-grid">
...
${Collections.sort(presidents)}
					...
					<c:forEach var="temp" items="${presidents}">
						<thead>
						...
						<tbody>
							<tr class="mainrows">
								<td class="mdl-data-table__cell--non-numeric">${temp.termNumber}</td>
	...
	<footer class="demo-footer mdl-mini-footer">
		<div class="mdl-mini-footer--left-section">
			<ul class="mdl-mini-footer--link-list">
				<li><a href="#">© skill Distillery </a></li>
